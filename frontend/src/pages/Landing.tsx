      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <div className="animate-fade-in">
            <div className="w-[100px] rounded-2xl mx-auto mb-8 flex items-center justify-center shadow-glow">
            ...
            <p className="text-2xl md:text-3xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Own your subscriptions, on{" "}
              <span className="text-primary font-semibold">Starknet</span>
            </p>

            <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
              Take control of your digital subscriptions with decentralized,
              transparent, and user-owned subscription management. No more
              forgotten payments or hidden fees.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 text-center hover:shadow-lg transition-all duration-300 animate-slide-up">
              ...
              <p className="text-muted-foreground">
                Your subscriptions, your data, your control. Built on
                decentralized infrastructure you can trust.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Automated renewals, instant notifications, and seamless payment
                processing on Starknet.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Easy plan creation, instant payouts, and direct relationships
        ...
        <div className="container mx-auto text-center">
          <Card className="p-12 bg-gradient-subtle border-primary/20">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join the future of subscription management. Transparent,
              decentralized, and built for you.
            </p>
